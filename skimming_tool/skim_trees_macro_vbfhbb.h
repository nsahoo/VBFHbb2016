...
#ifndef skim_trees_macro_vbfhbb_h
#define skim_trees_macro_vbfhbb_h
...
public :
   ...
   skim_trees_macro_vbfhbb(TString filename="");
   virtual ~skim_trees_macro_vbfhbb();
...
#ifdef skim_trees_macro_vbfhbb_cxx
skim_trees_macro_vbfhbb::skim_trees_macro_vbfhbb(TString filename) : fChain(0) 
{
...
void skim_trees_macro_vbfhbb::AddFile(TString filename)
{
	file_name = filename;
...
skim_trees_macro_vbfhbb::~skim_trees_macro_vbfhbb()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t skim_trees_macro_vbfhbb::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t skim_trees_macro_vbfhbb::LoadTree(Long64_t entry)
{
...
void skim_trees_macro_vbfhbb::Init(TString filename)
{
...
Bool_t skim_trees_macro_vbfhbb::Notify()
{
...
void skim_trees_macro_vbfhbb::Show(Long64_t entry)
{
...
Int_t skim_trees_macro_vbfhbb::Cut(Long64_t entry)
{
...
#endif // #ifdef skim_trees_macro_vbfhbb_cxx
