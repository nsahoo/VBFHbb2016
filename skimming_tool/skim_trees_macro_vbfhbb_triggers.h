...
#ifndef skim_trees_macro_vbfhbb_triggers_h
#define skim_trees_macro_vbfhbb_triggers_h
...
class skim_trees_macro_vbfhbb_triggers {
public :
   ...
   Int_t           GenBQuarkFromTop_pdgId[4];   //[nGenBQuarkFromTop]
   Float_t         GenBQuarkFromTop_pt[4];   //[nGenBQuarkFromTop]
   Float_t         GenBQuarkFromTop_eta[4];   //[nGenBQuarkFromTop]
   Float_t         GenBQuarkFromTop_phi[4];   //[nGenBQuarkFromTop]
   Float_t         GenBQuarkFromTop_mass[4];   //[nGenBQuarkFromTop]
   Float_t         GenBQuarkFromTop_charge[4];   //[nGenBQuarkFromTop]
   Int_t           GenBQuarkFromTop_status[4];   //[nGenBQuarkFromTop]
   Int_t           GenBQuarkFromTop_isPromptHard[4];   //[nGenBQuarkFromTop]
   ...
   Int_t           GenHadTaus_isPromptHard[2];   //[nGenHadTaus]
   ...
   Int_t           nGenJet;
   Float_t         GenJet_charge[13];   //[nGenJet]
   Int_t           GenJet_status[13];   //[nGenJet]
   Int_t           GenJet_isPromptHard[13];   //[nGenJet]
   Int_t           GenJet_pdgId[13];   //[nGenJet]
   Float_t         GenJet_pt[13];   //[nGenJet]
   Float_t         GenJet_eta[13];   //[nGenJet]
   Float_t         GenJet_phi[13];   //[nGenJet]
   Float_t         GenJet_mass[13];   //[nGenJet]
   Int_t           GenJet_numBHadrons[13];   //[nGenJet]
   Int_t           GenJet_numCHadrons[13];   //[nGenJet]
   Int_t           GenJet_numBHadronsFromTop[13];   //[nGenJet]
   Int_t           GenJet_numCHadronsFromTop[13];   //[nGenJet]
   Int_t           GenJet_numBHadronsAfterTop[13];   //[nGenJet]
   Int_t           GenJet_numCHadronsAfterTop[13];   //[nGenJet]
   Float_t         GenJet_wNuPt[13];   //[nGenJet]
   Float_t         GenJet_wNuEta[13];   //[nGenJet]
   Float_t         GenJet_wNuPhi[13];   //[nGenJet]
   Float_t         GenJet_wNuM[13];   //[nGenJet]
   Int_t           nGenVbosons;
   Int_t           GenVbosons_pdgId[3];   //[nGenVbosons]
   Float_t         GenVbosons_pt[3];   //[nGenVbosons]
   Float_t         GenVbosons_eta[3];   //[nGenVbosons]
   Float_t         GenVbosons_phi[3];   //[nGenVbosons]
   Float_t         GenVbosons_mass[3];   //[nGenVbosons]
   Float_t         GenVbosons_charge[3];   //[nGenVbosons]
   Int_t           GenVbosons_status[3];   //[nGenVbosons]
   Int_t           GenVbosons_isPromptHard[3];   //[nGenVbosons]
   ...
   Float_t         trgObjects_hltBTagCaloCSVp026DoubleWithMatching_pt[3];   //[ntrgObjects_hltBTagCaloCSVp026DoubleWithMatching]
   Float_t         trgObjects_hltBTagCaloCSVp026DoubleWithMatching_eta[3];   //[ntrgObjects_hltBTagCaloCSVp026DoubleWithMatching]
   Float_t         trgObjects_hltBTagCaloCSVp026DoubleWithMatching_phi[3];   //[ntrgObjects_hltBTagCaloCSVp026DoubleWithMatching]
   Float_t         trgObjects_hltBTagCaloCSVp026DoubleWithMatching_mass[3];   //[ntrgObjects_hltBTagCaloCSVp026DoubleWithMatching]
   Int_t           naLeptons;
   ...
   Int_t           aLeptons_mediumIdPOG_ICHEP2016[7];   //[naLeptons]
   ...
   Float_t         aLeptons_eleMVArawSpring16GenPurp[7];   //[naLeptons]
   Int_t           aLeptons_eleMVAIdSppring16GenPurp[7];   //[naLeptons]
   ...
   Float_t         aLeptons_SF_trk_eta[7];   //[naLeptons]
   Float_t         aLeptons_SFerr_trk_eta[7];   //[naLeptons]
   ...
   Int_t           nGenNuFromTau;
   Int_t           GenNuFromTau_pdgId[2];   //[nGenNuFromTau]
   Float_t         GenNuFromTau_pt[2];   //[nGenNuFromTau]
   Float_t         GenNuFromTau_eta[2];   //[nGenNuFromTau]
   Float_t         GenNuFromTau_phi[2];   //[nGenNuFromTau]
   Float_t         GenNuFromTau_mass[2];   //[nGenNuFromTau]
   Float_t         GenNuFromTau_charge[2];   //[nGenNuFromTau]
   Int_t           GenNuFromTau_status[2];   //[nGenNuFromTau]
   Int_t           GenNuFromTau_isPromptHard[2];   //[nGenNuFromTau]
   ...
   skim_trees_macro_vbfhbb_triggers(TString filename="");
   virtual ~skim_trees_macro_vbfhbb_triggers();
...
#ifdef skim_trees_macro_vbfhbb_triggers_cxx
skim_trees_macro_vbfhbb_triggers::skim_trees_macro_vbfhbb_triggers(TString filename) : fChain(0) 
{
...
void skim_trees_macro_vbfhbb_triggers::AddFile(TString filename)
{
	file_name = filename;
...
skim_trees_macro_vbfhbb_triggers::~skim_trees_macro_vbfhbb_triggers()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t skim_trees_macro_vbfhbb_triggers::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t skim_trees_macro_vbfhbb_triggers::LoadTree(Long64_t entry)
{
...
void skim_trees_macro_vbfhbb_triggers::Init(TString filename)
{
...
Bool_t skim_trees_macro_vbfhbb_triggers::Notify()
{
...
void skim_trees_macro_vbfhbb_triggers::Show(Long64_t entry)
{
...
Int_t skim_trees_macro_vbfhbb_triggers::Cut(Long64_t entry)
{
...
#endif // #ifdef skim_trees_macro_vbfhbb_triggers_cxx
